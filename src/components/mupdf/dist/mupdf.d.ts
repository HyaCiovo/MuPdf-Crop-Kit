...
export declare class Document extends Userdata<"any_document"> {
    ...
    static openDocument(from: Buffer | ArrayBuffer | Uint8Array | Stream, magic: string): PDFDocument;
...
type PDFAnnotationIntent = null | "FreeTextCallout" | "FreeTextTypeWriter" | "LineArrow" | "LineDimension" | "PloyLine" | "PolygonCloud" | "PolygonDimension" | "StampImage" | "StampSnapshot";
